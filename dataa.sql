...
CREATE TABLE Appointmentaajkahai(
id int PRIMARY KEY,
date DATE NOT NULL,
...
CREATE TABLE PatientsfamilyAppointments(
...
CREATE TABLE DoctoropinionHistory(
history int NOT NULL,
doctor varchar(50) NOT NULL,
FOREIGN KEY (doctor) REFERENCES Doctor (email) ON DELETE CASCADE,
FOREIGN KEY (history) REFERENCES MedicalHistory (id) ON DELETE CASCADE,
